            ...
            <div class="modal-body">
                <form action="updateMaterial/{$Materiales->id_materiales}" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-group" value="{$Materiales->nombre}" name="nombre"
                            placeholder="Material" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label"> Aceptado 1 Si 0 No: </label>
                        <input type="number" min="0" max="1" value="{$Materiales->aceptado}" class="form-group" id=""
                            name="aceptado" placeholder="Aceptado" required>
                    </div>
                    <div class="form-group">
