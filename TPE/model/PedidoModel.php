...
class PedidoModel
{
    ...
    function AddPedido($nombre, $apellido, $ubicacion, $telefono, $claseVehiculo, $imagen)
    {
        ...
        $sentencia = $this->db->prepare("INSERT INTO pedido(nombre, apellido, ubicacion, telefono, clase_vehiculo ,foto) VALUES(?,?,?,?,?,?)");
        $sentencia->execute(array($nombre, $apellido, $ubicacion, $telefono, $claseVehiculo, $imagen["filePath"]));
    }
}
